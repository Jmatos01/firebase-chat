function buildSignUpScreen(user){
    $('#sign-in-screen').fadeOut("slow", function(){
        $('#root').html(SignUpScreen(user));
        intializeSignUpScreenEventListeners(user);
    });
}
...
function intializeSignUpScreenEventListeners(){
    $('#go_back_btn').on('click', goBack);

    $('#sign_up_btn').on('click',signUp);
}
